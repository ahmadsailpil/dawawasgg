/** 
 - Create By dodot
 - Contact Me on https://wa.me/+6283160327945
 - Follow iG : @dodot
...
url: 'https://instagram.com/ohlx_store?utm_medium=copy_link'
}
}, {
quickReplyButton: {
displayText: '📈Status',
...
sock.sendMessage(from, { caption: listmn, location: { jpegThumbnail: fs.readFileSync('./worker/media/image/loc.jpg') }, buttons: but, footer: '©FAXTBOT'})
}
break
break
case prefix+'gura':
...
let txt = `*「 Broadcast」*\n\n${text}`
sock.send5ButImg(i, txt, "© FAXTBOT", log0, btn, thum)
}
...
let txt = `*「 Broadcast」*\n\n${text}`
sock.send5ButImg(yoi, txt, "© FAXTBOT", log0, btn, thum)
}
