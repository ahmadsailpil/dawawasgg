...
async function __START() {
    ...
    const sock = sockConnect({
        ...
        browser: ['dodot Multi Device','Safari','1.0.0'],
        auth: state,
        version
    })
console.log(color('[dodot CHAN]', 'cyan'), color('Bot Online', 'yellow'))
console.log(color('[WARNING]', 'cyan'), color(`INGFO CREATOR`, 'yellow'))
console.log(color('Instagram :', 'cyan'), color(`@dodot.xyz`, 'yellow'))
console.log(color('Github :', 'cyan'), color(`@Dodot`, 'yellow'))
console.log(color('Wangsap :', 'cyan'), color(`083848128003`, 'yellow'))
console.log(color('\n', 'cyan'), color('\nWelcome back, Owner! Hope you are doing well~', 'yellow'))

sock.browserDescription = ["FAXT-MD", "Mac", "3.0.0"];
